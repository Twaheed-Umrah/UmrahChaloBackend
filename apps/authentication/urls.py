...
urlpatterns = [
    ...
    path('providers/', include([
        ...
        path('service-provider/media/', views.ProviderMediaUploadView.as_view(), name='provider-media-upload'),
        path('service-provider/media/<int:pk>/', views.ProviderMediaDeleteView.as_view(), name='provider-media-delete'),
