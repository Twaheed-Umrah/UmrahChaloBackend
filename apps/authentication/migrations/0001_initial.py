    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(choices=[('individual', 'Individual'), ('company', 'Company'), ('agency', 'Travel Agency')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('pilgrim', 'Pilgrim'), ('provider', 'Service Provider'), ('admin', 'Super Admin')], default='pilgrim', max_length=20)),
