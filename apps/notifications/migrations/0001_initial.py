    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_user_type', models.CharField(choices=[('all', 'All Users'), ('pilgrims', 'Pilgrims'), ('providers', 'Service Providers'), ('premium_providers', 'Premium Providers')], default='all', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-sent_at'],
                'indexes': [models.Index(fields=['notification', 'channel'], name='notificatio_notific_6b2a25_idx'), models.Index(fields=['sent_at'], name='notificatio_sent_at_85d1ed_idx')],
            },
        ),
        migrations.AddIndex(
